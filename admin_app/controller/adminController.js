...
module.exports = {
    ...
    adminLogin: async (req, res) => {
        try {
            ...
            // Verify password
            const isValidPassword = await bcrypt.compare(empPassword, admin.empPassword);
            if (!isValidPassword) {
    ...
    empDashBoard: async (req, res) => {
        try {
            ...
            const employeeData = employees.map(emp => {
                ...
                const isClockedIn = todayTimeSheet && todayTimeSheet.clockIn && !todayTimeSheet.clockOut;
                const isOnBreak = todayTimeSheet && todayTimeSheet.breakStart && !todayTimeSheet.breakEnd;
                const isCompleted = todayTimeSheet && todayTimeSheet.clockIn && todayTimeSheet.clockOut;
